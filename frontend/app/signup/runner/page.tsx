...
import { Eye, EyeOff, Mail, Lock, User, Calendar, ArrowRight, Zap } from "lucide-react"
...
export default function RunnerSignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("Relay runner registration:", formData)
  }
        ...
        >
          ...
          <div className="text-center mb-8">
            <div className="w-16 h-16 bg-[#EAEAE8]/10 border border-[#EAEAE8]/20 rounded-lg flex items-center justify-center mx-auto mb-4">
              <Zap className="w-8 h-8 text-[#EAEAE8]" />
            </div>
            <h1 className="heading-font text-2xl font-bold mb-2">BECOME A RELAY RUNNER</h1>
            <p className="text-[#868684]">Join the elite ranks of relay racers and perfect your handoff technique</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              <div className="absolute left-3 top-1/2 transform -translate-y-1/2 z-10">
                <Calendar className="w-5 h-5 text-[#868684]" />
              </div>
              <input
                type="date"
                name="dateOfBirth"
                ...
                onChange={handleInputChange}
                className={`w-full bg-transparent border-2 border-[#868684]/30 pl-12 pr-4 py-3 text-white focus:outline-none focus:border-[#EAEAE8] transition-all duration-300 ${
                  focusedField === "dateOfBirth" ? "border-[#EAEAE8] scale-105" : ""
                }`}
            ...
            >
              {isSubmitting ? (
                <>
                  ...
                  <span>JOINING RELAY LEAGUE...</span>
                </>
              ) : (
                <>
                  <span>CREATE RELAY RUNNER ACCOUNT</span>
          ...
          <div className="mt-6 pt-6 border-t border-[#868684]/20 text-center">
            <p className="text-[#868684] mb-2">Want to manage a relay team instead?</p>
            <Link href="/signup/manager" className="text-[#EAEAE8] hover:text-white transition-colors text-sm">
